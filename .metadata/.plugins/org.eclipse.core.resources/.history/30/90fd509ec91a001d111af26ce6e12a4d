...
//		boolean result = menuService.deleteMenu(281);
		
//		menuService.insertCategory(new CategoryDTO(0,"mvc-category",8));
		List<CategoryDTO> list = menuService.selectAllCategory();
